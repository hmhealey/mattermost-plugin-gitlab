...
// 		userID := p.getGitLabToUserIDMapping(username)
// 		if userID == "" {
// 			continue
// 		}
...
// 	authorUserID := p.getGitLabToUserIDMapping(author)
// 	if authorUserID == "" {
// 		return
// 	}
...
// 			requestedUserID = p.getGitLabToUserIDMapping(requestedReviewer)
...
// 		assigneeUserID = p.getGitLabToUserIDMapping(event.GetPullRequest().GetAssignee().GetLogin())
// 	}
...
// 		assigneeUserID = p.getGitLabToUserIDMapping(event.GetAssignee().GetLogin())
// 	}
